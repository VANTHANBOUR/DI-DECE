                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-3">
                          <UserAvatar
                            src={user.avatar}
                            name={user.name}
                            className="w-10 h-10 rounded-xl ring-2 ring-emerald-500/20 shrink-0"
                          />
                          <div>
                    ...
                    <td className="py-3.5 px-3">
                      <div className="flex items-center gap-3">
                        <UserAvatar
                          ...
                          className="w-8 h-8 rounded-lg ring-1 ring-emerald-500/20 shrink-0"
                        />
                  ...
                  >
                    <div className="flex items-start gap-3.5 flex-1 min-w-0">
                      ...
                      <UserAvatar
                        ...
                        className="w-11 h-11 rounded-xl ring-2 ring-emerald-500/20 shrink-0"
                      />
          ...
          <div className="bg-white rounded-3xl p-6 max-w-md w-full shadow-2xl border border-rose-100 space-y-4 animate-in fade-in zoom-in-95">
            ...
            <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200 flex items-center gap-3">
              <UserAvatar
                ...
                className="w-11 h-11 rounded-xl ring-2 ring-rose-500/20 shrink-0"
              />
